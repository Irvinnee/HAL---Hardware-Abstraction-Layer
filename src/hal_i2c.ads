...
-- Default: IIC1 (A4/SDA=P101, A5/SCL=P100) on UNO R4 Minima headers
...
package HAL_I2C is
   ...
   --  I2C_0 = IIC0 (internal / alt pins)
   --  I2C_1 = IIC1 (A4/SDA=P101, A5/SCL=P100) - Arduino header I2C
   ...
   -- Default: Bus 1 (Arduino header), 100 kHz
   Default_Config : constant I2C_Config :=
     (Bus => I2C_1, Speed => Standard_100K);
